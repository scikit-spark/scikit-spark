...
from . sklearn_version_specific_utils import sklearn_is_0_19, sklearn_is_0_20, sklearn_is_0_21
...
class ResourceWarningTests(PySparkTest):
    ...
    @skipIf(not sklearn_is_0_20(), "0.20 version of test")
    ...
    @skipIf(not (sklearn_is_0_20() or sklearn_is_0_21()), "test only applicable to sklearn 0.20 and 0.21")
