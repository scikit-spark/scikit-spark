...
class SparkBaseSearchCV(BaseSearchCV):
    ...
    def _run_sklearn_fit(self, X, y, base_estimator, routed_params, cv_orig, n_splits, refit_metric, fit_and_score_kwargs):
    ...
    def _run_skspark_fit(self, X, y, base_estimator, routed_params, cv_orig, n_splits, refit_metric, fit_and_score_kwargs):
        results = {}
        all_candidate_params = []
        all_out = []
        all_more_results = defaultdict(list)
        ...
        def evaluate_candidates(candidate_params, cv=None, more_results=None):
            ...
            param_grid = [
                ...
                in product(enumerate(candidate_params), enumerate(cv.split(X, y, **routed_params.splitter.split)))
            ]
